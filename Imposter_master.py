...
def menu():
    ...
    print('#                                                                                                             #')
    print('###############################################################################################################')
    print("if you are using mouse then you'll have to open and close the map to get the kill option to show after you toggle imposter but if your using keyboard & mouse it will happen automatically" )
